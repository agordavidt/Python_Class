...
label_result = Label(root,width=25,height=2,text="",font=("arial",30), bg='yellow')
label_result.pack()
...
Button(root,text="3", width=5, height=1, font=("arial",30,"bold"), bd=1, fg="#fff",bg="#2a2d36").place(x=10,y=400)
